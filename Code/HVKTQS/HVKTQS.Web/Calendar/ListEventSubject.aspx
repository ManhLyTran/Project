<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListEventSubject.aspx.cs" Inherits="HVKTQS.Web.Calendar.ListEventSubject" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-head">
        <div class="page-title break-head">
            <h1>Quản lý sự kiện bộ môn</h1>
        </div>
        <div class="page-toolbar">
            <asp:LinkButton runat="server" ID="lbtAddEvent" CssClass="btn btn-default" OnClick="lbtAddEvent_Click">
                     <i class="fa fa-plus"></i>Thêm mới sự kiện bộ môn
            </asp:LinkButton>
        </div>
    </div>
    <div class="row">
